...
export default function ProductDetail() {
    ...
    if (loading) {
        return (
           <Loader text="Đang tải chi tiết sản phẩm..." subtext="Vui lòng chờ trong giây lát" />
        )
    }
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                    ...
                    <div className="relative">
                        <Badge className="absolute top-4 left-4 z-10 bg-red-600 text-white text-sm px-2 py-1 rounded-md font-medium">
                            -{product.discount}
                        </Badge>
                        <img
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2">
                        {product.images.map((image: string, index: number) => (
                            <button
                                ...
                                className={`relative overflow-hidden rounded border-2 transition-all duration-200 ${selectedImageIndex === index
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <Badge className="bg-green-100 text-green-800 text-sm px-2 py-1 rounded-md">
                                {product.sold} Đã Bán
                            </Badge>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Badge className="bg-red-100 text-red-800 text-sm px-2 py-1 rounded-md">
